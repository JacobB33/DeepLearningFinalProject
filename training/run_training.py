...
def get_train_objs(encoder_config, opt_cfg: OptimizerConfig, data_cfg: DataConfig):
...
def main(cfg: DictConfig):
    ...
    model, optimizer, train_data, test_data = get_train_objs(encoder_config, opt_cfg, data_cfg)
